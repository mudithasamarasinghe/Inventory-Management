<div class="card card-outline card-primary">
	<div class="card-header">
        ...
        <!-- <div class="card-tools">
			<a href="<?php echo base_url ?>admin/index.php?page=back_order/manage_bo" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create New</a>
		</div> -->
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT p.*, s.name as supplier FROM `back_orders` p inner join suppliers s on p.supplier_id = s.id order by p.`date_created` desc");
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <?php if($row['status'] == 0): ?>
                                        ...
                                        <a class="dropdown-item" href="<?php echo base_url.'admin/index.php?page=receiving/manage_receiving&bo_id='.$row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-boxes text-dark"></span> Receive</a>
                                        <div class="dropdown-divider"></div>
                                    <?php endif; ?>
                                        <a class="dropdown-item" href="<?php echo base_url.'admin/index.php?page=back_order/view_bo&id='.$row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endwhile; ?>
