    ...
    <div class="container-fluid">
        <div class="form-group">
            ...
            <input type="text" name="aweclass" id="aweclass" class="form-control rounded-0" value="<?php echo isset($aweclass) ? $aweclass :"" ?>" required>
		        ...
		        <div class="form-group">
            <label for="db_name" class="control-label">DB Name</label>
            <input type="text" name="db_name" id="db_name" class="form-control rounded-0" value="<?php echo isset($db_name) ? $db_name :"" ?>" required>
        </div>
				        <div class="form-group">
            <label for="bg_color" class="control-label">BG Color</label>
            <input type="text" name="bg_color" id="bg_color" class="form-control rounded-0" value="<?php echo isset($bg_color) ? $bg_color :"" ?>" required>
        </div>
        <div class="form-group">
